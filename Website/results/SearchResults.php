...
switch($OrderSearch){
	...
	$search_sql = "SELECT Project_ID, Project_Description, Project_Name, Group_Members, Date_Uploaded, Rating_Total	FROM $dbName WHERE Project_ID LIKE '%$Advanced_Search_ID%'";//bad try
